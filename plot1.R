...
# Create plot
# Note: ylim=c(0,1200) needed to show 1200 on axis, otherwise only went to 1000
with(hhData,hist(x=Global_active_power, xlab = "Global Active Power (kilowatts)",
